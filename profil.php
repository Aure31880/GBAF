        ...
        <section class="group-list">
            <article>
                <div class="presentation">
                    ...
                    <p class="overflow-visible"> Le GBAF est le représentant de la profession bancaire et des assureurs
                        sur
                        tous
                ...
                <div class="card mb-3" id="card-partenaire">
                    <div class=" row no-gutters">
                        <div class="col-md-4" id="logo-card">
                            <img src="<?= htmlspecialchars($posts['logo']); ?>" class="card-img"
                                alt="logo-partenaire" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
